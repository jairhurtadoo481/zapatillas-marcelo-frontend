        ...
        <div className="max-w-2xl mx-auto px-4 py-10">
          ...
          <div className="grid grid-cols-3 gap-3 mb-8">
            ...
            <div className="border border-gray-200 rounded-lg p-4 text-center bg-white">
              ...
              <p className={`text-xl font-bold ${resumen.comprasPendientes > 0 ? "text-yellow-600" : "text-gray-900"}`}>
                {cargandoResumen ? "..." : resumen.comprasPendientes}
              </p>
            </div>
            <div className="border border-gray-200 rounded-lg p-4 text-center bg-white">
              <p className="text-xs text-gray-500">Stock bajo</p>
              <p className={`text-xl font-bold ${resumen.stockBajo > 0 ? "text-red-600" : "text-gray-900"}`}>
